module github.com/w0rxbend/instachron/services/camera-web-api
...
require github.com/w0rxbend/instachron/shared/envconf v0.0.0

require github.com/w0rxbend/instachron/shared/dropchan v0.0.0 // indirect
